  ...
  return (
    <div className="sidebar-admin">
      ...
      <ul className="sidebar-menu">
        ...
        {/* User management */}
        <li onClick={() => handleMenuItemClick("/admin/users")}>
          Quản lý người dùng
        </li>

        {/* Driver License Requests */}
        <li
          onClick={() => handleMenuItemClick("/admin/driver-license-requests")}
        >
          Duyệt GPLX
        </li>

        {/* Owner Requests */}
        <li onClick={() => handleMenuItemClick("/admin/owner-requests")}>
          Duyệt chủ xe
        </li>

        {/* Vehicle Approvals */}
        <li onClick={() => handleMenuItemClick("/admin/vehicle-approvals")}>
          Duyệt xe
        </li>
        ...
        {/* Payout Requests */}
        <li onClick={() => handleMenuItemClick("/admin/payout-requests")}>
          Duyệt giải ngân
        </li>
        {/* Payout Requests */}
        <li onClick={() => handleMenuItemClick("/admin/deposit-refunds")}>
          Hoàn tiền cọc{" "}
        </li>

        {/* Notifications */}
        <li onClick={() => handleMenuItemClick("/admin/notifications")}>
          Thông báo
        </li>
