...
const OwnerContractPage = () => {
  ...
  return (
    <div className="owner-contract-layout">
      <SidebarOwner />
      <div className="owner-contract-content">
        <ToastContainer position="top-right" autoClose={2000} />
        <button
          className="owner-contract-back-btn"
          onClick={() => navigate('/ownerpage/booking-management')}
        >
          ← Quay lại 
        </button>
        {ownerSignature ? (
          <div style={{
            ...
            Bạn đã ký xác nhận hợp đồng. Có thể tiến hành giao xe.
          </div>
        ) : (
          <div style={{
            background: '#fffbe6',
            ...
            Vui lòng ký tên xác nhận trước khi thực hiện giao xe.
          </div>
        )}
        <div className="contract-a4-container">
          <main className="contract-content">
            {/* Nội dung hợp đồng giống như ContractPage.jsx */}
...
export default OwnerContractPage; 